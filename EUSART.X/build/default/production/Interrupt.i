...
void __attribute__((picinterrupt(("high_priority")))) INT2_Ext(void);
void __attribute__((picinterrupt(("low_priority")))) INT1_Ext(void);
# 3 "Interrupt.c" 2
...
void __attribute__((picinterrupt(("high_priority")))) INT0_Ext(void){

    INTCONbits.INT0F = 0;
}

void __attribute__((picinterrupt(("low_priority")))) Recepcion_Ext(void){
    datos[i] = RCREG;
    i++;
    a++;
    PIR1bits.RCIF = 0;
