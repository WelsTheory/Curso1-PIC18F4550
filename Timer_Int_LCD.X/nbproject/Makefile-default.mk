...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=Configuracion.c Interrupt.c LCD_Libreria.c Programa_principal.c Timer0_Libreria.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Configuracion.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD_Libreria.p1 ${OBJECTDIR}/Programa_principal.p1 ${OBJECTDIR}/Timer0_Libreria.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Configuracion.p1.d ${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/LCD_Libreria.p1.d ${OBJECTDIR}/Programa_principal.p1.d ${OBJECTDIR}/Timer0_Libreria.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Configuracion.p1 ${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/LCD_Libreria.p1 ${OBJECTDIR}/Programa_principal.p1 ${OBJECTDIR}/Timer0_Libreria.p1

# Source Files
SOURCEFILES=Configuracion.c Interrupt.c LCD_Libreria.c Programa_principal.c Timer0_Libreria.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/Timer0_Libreria.p1: Timer0_Libreria.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/Timer0_Libreria.p1.d 
	@${RM} ${OBJECTDIR}/Timer0_Libreria.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/Timer0_Libreria.p1 Timer0_Libreria.c 
	@-${MV} ${OBJECTDIR}/Timer0_Libreria.d ${OBJECTDIR}/Timer0_Libreria.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/Timer0_Libreria.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Timer_Int_LCD.X.${IMAGE_TYPE}.hex 
